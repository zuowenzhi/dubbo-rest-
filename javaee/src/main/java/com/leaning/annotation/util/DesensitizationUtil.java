package com.leaning.annotation.util;
...
public class DesensitizationUtil {
     ...
     *
     * @param str
     * @param headCharCount 3
     * @param tailCharCount 2
     * @return
     */
    public static String around(String str, int headCharCount, int tailCharCount) {
